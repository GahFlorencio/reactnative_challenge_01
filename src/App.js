...
export default function App() {
  ...
  async function handleLikeRepository(id) {
    ...
    repository.likes = response.likes;
    
    setRepositories([...repositories.slice(0,repositoryIndex),repository,...repositories.slice(repositoryIndex+1,repositories.length)])
